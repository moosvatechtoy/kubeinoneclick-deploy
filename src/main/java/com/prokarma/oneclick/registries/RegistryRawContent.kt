...
abstract class RegistryRawContent(private val registryType: RegistryType, private val restTemplate: RestTemplate) {
    ...
    open fun matches(module: com.prokarma.oneclick.modules.bo.TerraformModule) = registryType == module.registryDetails?.registryType

    open fun getReadme(module: com.prokarma.oneclick.modules.bo.TerraformModule): Optional<String> {
