...
class SecurityConfig(
        val successHandler: com.prokarma.oneclick.config.security.SuccessHandler,
        val failureHandler: com.prokarma.oneclick.config.security.FailureHandler,
        val logoutSuccessHandler: com.prokarma.oneclick.config.security.LogoutSuccessHandler,
        val accessDeniedHandler: com.prokarma.oneclick.config.security.AccessDeniedHandler,
        val authenticationEntryPoint: com.prokarma.oneclick.config.security.AuthenticationEntryPoint) : WebSecurityConfigurerAdapter() {

    @Value("\${oneclick.admin-password:admin123}")
    private val adminPassword: String? = null

    @Value("\${oneclick.remember-me-secret:oneclick-secret}")
