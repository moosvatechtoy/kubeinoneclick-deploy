...
import com.prokarma.oneclick.config.security.SuccessHandler
...
class OAuth2SuccessHandler(
        ...
        val registryOAuth2Providers: List<com.prokarma.oneclick.registries.RegistryOAuth2Provider>,
        val oAuth2AuthorizedClientService: OAuth2AuthorizedClientService) : com.prokarma.oneclick.config.security.SuccessHandler(userRepository) {
