...
class GitLabOAuth2ProviderTest {
    ...
    void isAssignableFor_shouldReturnTrue_forValidProvider() {
        Assertions.assertTrue(gitLabOAuth2Provider.isAssignableFor("gitlab"));
    }

    @Test
    void isAssignableFor_shouldReturnFalse_forInvalidProvider() {
        Assertions.assertFalse(gitLabOAuth2Provider.isAssignableFor("github"));
    }
    ...
    void getOAuth2Url_shouldReturnUrl_withToken() {
        // given
        var url = "https://gitlab.com/CodeKaio/oneclick.git";
        ...
        // then
        org.assertj.core.api.Assertions.assertThat(result).isNotNull().isEqualTo("https://oauth2:test_token@gitlab.com/CodeKaio/oneclick.git");
    }
}