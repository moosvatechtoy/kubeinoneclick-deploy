...
class GitHubOAuth2ProviderTest {
    ...
    void isAssignableFor_shouldReturnTrue_forValidProvider() {
        Assertions.assertTrue(gitHubOAuth2Provider.isAssignableFor("github"));
    }

    @Test
    void isAssignableFor_shouldReturnFalse_forInvalidProvider() {
        Assertions.assertFalse(gitHubOAuth2Provider.isAssignableFor("gitlab"));
    }
    ...
    void getOAuth2Url_shouldReturnUrl_withToken() {
        // given
        var url = "https://github.com/CodeKaio/oneclick.git";
        ...
        // then
        org.assertj.core.api.Assertions.assertThat(result).isNotNull().isEqualTo("https://oauth2:test_token@github.com/CodeKaio/oneclick.git");
    }
}