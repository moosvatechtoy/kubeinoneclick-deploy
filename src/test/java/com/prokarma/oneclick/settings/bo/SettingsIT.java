package com.prokarma.oneclick.settings.bo;
...
@TestPropertySource(properties = {
        "oneclick.externalUrl=http://172.17.0.1:8080",
        "oneclick.envVars[0].name=test",
        "oneclick.envVars[0].value=value"
})
class SettingsIT {
    ...
    void settings_shouldBeMergedWithSavedSettings(){
        ...
        savedSettings.setExternalUrl("https://oneclick.io");
        ...
        assertEquals("https://oneclick.io", settings.getExternalUrl());
        assertEquals("unix:///var/run/docker.sock", settings.getDockerDaemonUrl());
