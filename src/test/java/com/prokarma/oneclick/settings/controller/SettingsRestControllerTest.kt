...
import com.prokarma.oneclick.settings.bo.Settings.EnvVar
...
class SettingsRestControllerTest {
    ...
    @Mock
    lateinit var settings: com.prokarma.oneclick.settings.bo.Settings

    @Mock
    lateinit var settingsRepository: com.prokarma.oneclick.settings.repository.SettingsRepository
    ...
    fun `saveSettings() should register the settings`() {
        // given
        val editedSettings = com.prokarma.oneclick.settings.bo.Settings()
