package com.prokarma.oneclick.config.security.oauth2
...
class OAuth2SuccessHandlerTest {
    ...
    lateinit var oAuth2SuccessHandler: com.prokarma.oneclick.config.security.oauth2.OAuth2SuccessHandler

    lateinit var registryOAuth2Providers: MutableList<com.prokarma.oneclick.registries.RegistryOAuth2Provider>

    @BeforeEach
    fun setup() {
        registryOAuth2Providers = ArrayList()
        oAuth2SuccessHandler = com.prokarma.oneclick.config.security.oauth2.OAuth2SuccessHandler(userRepository, registryOAuth2Providers, oAuth2AuthorizedClientService)
    ...
    fun `onAuthenticationSuccess() should fill oAuth2User`() {
        ...
        val oauth2Provider = mock(com.prokarma.oneclick.registries.RegistryOAuth2Provider::class.java)
