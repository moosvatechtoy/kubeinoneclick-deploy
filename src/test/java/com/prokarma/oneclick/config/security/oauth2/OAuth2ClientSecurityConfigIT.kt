...
class OAuth2ClientSecurityConfigIT {
    ...
    inner class OAuth2ClientSecurityConfigNotLoadedTest {
        ...
        fun `oauth2ClientSecurityConfig should not be instantiated`(
            @Autowired(required = false) oauth2ClientSecurityConfig: com.prokarma.oneclick.config.security.oauth2.OAuth2ClientSecurityConfig?) {
            assertNull(oauth2ClientSecurityConfig)
        }

        @Test
        fun `oAuth2SuccessHandler should not be instantiated`(
            @Autowired(required = false) oAuth2SuccessHandler: com.prokarma.oneclick.config.security.oauth2.OAuth2SuccessHandler?) {
