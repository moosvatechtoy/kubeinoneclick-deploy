package com.prokarma.oneclick.test;
...
public class MongoContainer extends GenericContainer {
    ...
    public void start() {
        ...
        System.setProperty("oneclick.mongodb.uri", String.format("mongodb://localhost:%d/oneclick", mappedPort));
    ...
    public MongoDatabase getDatabase() {
        if (database == null) {
            database = getClient().getDatabase("oneclick");
        }
        return database;
    }
