package com.prokarma.oneclick.client.controller
...
class BuildInfoRestControllerTest {
    ...
    @InjectMocks
    lateinit var controller: com.prokarma.oneclick.client.controller.BuildInfoRestController
    ...
    fun `infos() should return nothing if no data`() {
        // given
        controller = com.prokarma.oneclick.client.controller.BuildInfoRestController(null, null)
